...
List<Book> list = (List<Book>)session.getAttribute("favourates");
@SuppressWarnings("unchecked")
...
<html lang="en">
	...
	<div class="container">
		...
		<table >
			...
			<%}%>
						<input type = "button" name = "delete" value = "移除" onclick="javascript:window.location.href='DeleteFavourateServlet?id=<%=b.getBookid()%>&username=<%=session.getAttribute("username")%>';">
					</form>
				</td>
			<%} }%>
		</table>
